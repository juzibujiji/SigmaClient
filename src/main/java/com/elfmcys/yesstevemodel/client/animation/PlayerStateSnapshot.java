...
public final class PlayerStateSnapshot {
    ...
    public final boolean ridingBoat;
    public final boolean ridingPig;
    public final boolean ridingLiving;
    ...
    private PlayerStateSnapshot(PlayerEntity player, float limbSwingAmount, float ageInTicks,
        ...
        this.sleeping = player.isSleeping() || player.getPose() == Pose.SLEEPING;
        this.climbing = player.isOnLadder();
        Entity vehicle = player.getRidingEntity();
        this.riding = vehicle != null;
        this.ridingBoat = vehicle instanceof net.minecraft.entity.item.BoatEntity;
        this.ridingPig = vehicle instanceof net.minecraft.entity.passive.PigEntity;
        this.ridingLiving = vehicle instanceof LivingEntity;
    ...
    private PlayerStateSnapshot(Entity entity, float limbSwingAmount, float ageInTicks,
        ...
        this.sleeping = entity.getPose() == Pose.SLEEPING;
        this.climbing = entity instanceof LivingEntity && ((LivingEntity) entity).isOnLadder();
