...
public class ChunkHolder {
    public static final Either<IChunk, ChunkHolder.IChunkLoadingError> MISSING_CHUNK = Either
            .right(ChunkHolder.IChunkLoadingError.UNLOADED);
    public static final CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> MISSING_CHUNK_FUTURE = CompletableFuture
            .completedFuture(MISSING_CHUNK);
    public static final Either<Chunk, ChunkHolder.IChunkLoadingError> UNLOADED_CHUNK = Either
            .right(ChunkHolder.IChunkLoadingError.UNLOADED);
    private static final CompletableFuture<Either<Chunk, ChunkHolder.IChunkLoadingError>> UNLOADED_CHUNK_FUTURE = CompletableFuture
            .completedFuture(UNLOADED_CHUNK);
    ...
    private final AtomicReferenceArray<CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>>> field_219312_g = new AtomicReferenceArray<>(
            CHUNK_STATUS_LIST.size());
    ...
    private boolean field_244382_p;
        private final ShortSet[] field_244383_q = new ShortSet[com.mentalfrostbyte.jello.util.game.world.WorldHeightHelper.getSectionCount()];
    ...
    public ChunkHolder(ChunkPos chunkPos, int level, WorldLightManager lightManager, ChunkHolder.IListener p_i50716_4_,
            ChunkHolder.IPlayerProvider playerProvider) {
        this.pos = chunkPos;
    ...
    public CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> func_219301_a(ChunkStatus p_219301_1_) {
        CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> completablefuture = this.field_219312_g
                .get(p_219301_1_.ordinal());
    ...
    public CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> func_225410_b(ChunkStatus p_225410_1_) {
        return getChunkStatusFromLevel(this.chunkLevel).isAtLeast(p_225410_1_) ? this.func_219301_a(p_225410_1_)
    ...
    public Chunk getChunkIfComplete() {
        ...
        Either<Chunk, ChunkHolder.IChunkLoadingError> either = completablefuture
                .getNow((Either<Chunk, ChunkHolder.IChunkLoadingError>) null);
    ...
    public void func_244386_a(BlockPos p_244386_1_) {
        ...
        if (chunk != null) {
            ...
            if (this.field_244383_q[b0 + com.mentalfrostbyte.jello.util.game.world.WorldHeightHelper.getSectionOffset()] == null) {
                this.field_244382_p = true;
                this.field_244383_q[b0 + com.mentalfrostbyte.jello.util.game.world.WorldHeightHelper.getSectionOffset()] = new ShortArraySet();
            }

            this.field_244383_q[b0 + com.mentalfrostbyte.jello.util.game.world.WorldHeightHelper.getSectionOffset()].add(SectionPos.toRelativeOffset(p_244386_1_));
        }
    }
    ...
    public void sendChanges(Chunk chunkIn) {
        if (this.field_244382_p || this.skyLightChangeMask != 0 || this.blockLightChangeMask != 0) {
            ...
            if (this.skyLightChangeMask != 0 || this.blockLightChangeMask != 0) {
                this.sendToTracking(new SUpdateLightPacket(chunkIn.getPos(), this.lightManager, this.skyLightChangeMask,
                        this.blockLightChangeMask, true), !this.field_244384_x);
            ...
            for (int k = 0; k < this.field_244383_q.length; ++k) {
                ...
                if (shortset != null) {
                    SectionPos sectionpos = SectionPos.from(chunkIn.getPos(), k - com.mentalfrostbyte.jello.util.game.world.WorldHeightHelper.getSectionOffset());
                    ...
                    if (shortset.size() == 1) {
                        ...
                        ChunkSection chunksection = chunkIn.getSections()[k]; // Use loop index 'k' (0-24) to access
                                                                              // correct section, avoiding Y=-4 crash
                        SMultiBlockChangePacket smultiblockchangepacket = new SMultiBlockChangePacket(sectionpos,
                                shortset, chunksection, this.field_244384_x);
    ...
    public CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> func_219276_a(ChunkStatus p_219276_1_,
        ...
        if (completablefuture != null) {
            Either<IChunk, ChunkHolder.IChunkLoadingError> either = completablefuture
                    .getNow((Either<IChunk, ChunkHolder.IChunkLoadingError>) null);
        ...
        if (getChunkStatusFromLevel(this.chunkLevel).isAtLeast(p_219276_1_)) {
            CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> completablefuture1 = p_219276_2_
                    .func_219244_a(this, p_219276_1_);
